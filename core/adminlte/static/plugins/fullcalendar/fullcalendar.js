...
var Grid = fc.Grid = RowRenderer.extend({
	...
	setRange: function(range) {
		...
		// Populate option-derived bak_settings. Look for override first, then compute if necessary.
...
var View = fc.View = Class.extend({
	...
	// Builds a moment using the bak_settings of the current calendar: timezone and language.
...
function EventManager(options) { // assumed to be a calendar
	...
	// according to the constraint/overlap bak_settings.
